    ...
    try:
        result = subprocess.run(
            ['npx', '--yes', 'terser', JS_SRC,
             ...
             '--mangle', 'toplevel,reserved=[handleLogin,handleLogout,openSucursalModal,openGrupoModal,toggleAgrupacion,loadSupervisionAreas,handleNDAAccept,loginWithBiometric,enrollBiometric,dismissEnrollPrompt]',
             '--output', JS_OUT],
